...
file(GLOB_RECURSE CPP_FILES "${CMAKE_SOURCE_DIR}/src/*.cpp" "${CMAKE_SOURCE_DIR}/test/*.cpp" "${CMAKE_SOURCE_DIR}/ci/*.cpp" "${CMAKE_SOURCE_DIR}/bench/*.cpp")
file(GLOB_RECURSE H_FILES "${CMAKE_SOURCE_DIR}/src/*.h" "${CMAKE_SOURCE_DIR}/test/*.h" "${CMAKE_SOURCE_DIR}/ci/*.h" "${CMAKE_SOURCE_DIR}/bench/*.h")
